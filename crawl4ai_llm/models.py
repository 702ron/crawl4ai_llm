...
class ProductImage(BaseModel):
    ...
    position: Optional[int] = Field(None, description="Position/order of the image in the product gallery")
...
class ProductPrice(BaseModel):
    ...
    original_price: Optional[float] = Field(None, description="Original/list price before any discounts")
    discount_percentage: Optional[float] = Field(None, description="Discount percentage if on sale")
    discount_amount: Optional[float] = Field(None, description="Discount amount if on sale")
    price_per_unit: Optional[str] = Field(None, description="Price per unit for measurement-based products")
...
class ProductVariant(BaseModel):
    ...
    attributes: List[ProductAttribute] = Field(default_factory=list, description="List of variant attributes")
    price: Optional[ProductPrice] = Field(None, description="Price of this specific variant")
    image: Optional[ProductImage] = Field(None, description="Image specific to this variant")
    availability: Optional[str] = Field(None, description="Availability status of this variant")
...
class ProductData(BaseModel):
    ...
    short_description: Optional[str] = Field(None, description="Short product description or subtitle")
    ...
    # Additional data
    category: Optional[List[str]] = Field(None, description="Product categories as a breadcrumb path")
    ...
    reviews: Optional[List[ProductReview]] = Field(None, description="List of product reviews")
    variants: Optional[List[ProductVariant]] = Field(None, description="List of product variants")
    attributes: Optional[List[ProductAttribute]] = Field(None, description="List of product attributes")
    
    # Metadata
    extracted_at: Optional[str] = Field(None, description="Timestamp of when the data was extracted")
    source: Optional[str] = Field(None, description="Source website or platform")
    raw_data: Optional[Dict[str, Any]] = Field(None, description="Raw extracted data before processing")
    extraction_success: bool = Field(True, description="Whether the extraction was successful")
