...
async def extract_product(
    url: str, strategy: str = "auto_schema", no_fallback: bool = False
):
    """
    ...
    product_data = await extractor.extract(
        url=url, strategy=strategy, fallback=not no_fallback
    )
...
def main():
    ...
    parser.add_argument("url", help="URL of the product page to extract data from")
    parser.add_argument(
        "--strategy",
