...
from crawl4ai_llm import (ProductData, ProductImage, ProductPrice, get_config,
                          get_storage)
...
async def storage_demo() -> None:
    ...
    storage_config = StorageConfig(type="json", path="./demo_data", use_uuid=True)
    ...
    logger.info(
        f"Product price: {retrieved_product.price.current_price} {retrieved_product.price.currency}"
    )
