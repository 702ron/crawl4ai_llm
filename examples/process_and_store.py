...
async def main(url: str, output_dir: str, extraction_strategy: str = "auto", cleanup: bool = False):
    """
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Extract, process, and store product data")
    parser.add_argument("url", help="URL of the product page to extract from")
    parser.add_argument("--output-dir", "-o", default="./data", help="Directory to store extracted products")
    parser.add_argument("--strategy", "-s", default="auto", choices=["auto", "llm", "schema"], help="Extraction strategy")
    parser.add_argument("--cleanup", "-c", action="store_true", help="Clean up output directory before starting")
