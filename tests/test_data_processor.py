...
from crawl4ai_llm.models import ProductData, ProductPrice, ProductImage, ProductAttribute, ProductReview
...
class TestDataProcessor:
    ...
    def test_process_product_data(self):
        ...
        product = ProductData(
            ...
            images=[
                ...
                ProductImage(url="https://example.com/image2.jpg", alt="<b>Another</b> Image")
            ],
            attributes=[
    ...
    def test_edge_cases(self):
        ...
        minimal_product = ProductData(
            ...
            prices=[ProductPrice(amount="10", currency="USD")]
        )
