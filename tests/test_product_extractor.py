...
class TestProductExtractor(unittest.TestCase):
    ...
    @patch('crawl4ai_llm.extraction.product_extractor.ProductExtractor.extract_with_auto_schema')
    async def test_extract_with_auto_schema_strategy(self, mock_extract_with_auto_schema):
    ...
    @patch('crawl4ai_llm.extraction.product_extractor.ProductExtractor.extract_with_llm')
    ...
    @patch('crawl4ai_llm.extraction.product_extractor.ProductExtractor.extract_with_auto_schema')
    @patch('crawl4ai_llm.extraction.product_extractor.ProductExtractor.extract_with_llm')
    async def test_extract_with_fallback(self, mock_extract_with_llm, mock_extract_with_auto_schema):
        ...
        # Test extraction
        extractor = ProductExtractor()
        result = await extractor.extract(self.test_url, strategy="auto_schema", fallback=True)
    ...
    @patch('crawl4ai_llm.extraction.product_extractor.ProductExtractor.extract_with_auto_schema')
    async def test_extract_with_content_filters(self, mock_extract_with_auto_schema, mock_crawler_class):
    ...
    @patch('crawl4ai_llm.crawler.base.BaseCrawler')
    @patch('crawl4ai_llm.extraction.product_extractor.ProductExtractor.extract_with_auto_schema')
    async def test_extract_with_one_time_content_filters(self, mock_extract_with_auto_schema, mock_crawler_class):
        ...
        result = await extractor.extract(
            ...
            content_filters=[one_time_filter]
        )
